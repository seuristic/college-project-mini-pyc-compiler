...
if [[ $# -eq 2 ]]; then
    if [[ $1 == "-S" ]] || [[ $1 == "-s" ]] || [[ $1 == "-si1" ]] || [[ $1 == "-i1s" ]] || [[ $1 == "-Si1" ]] || [[ $1 == "-i1S" ]]; then 
        if test -f "$2"; then
            ...
            cat $2 | ./python.out | python3 opt1.py | python3 compile.py > $fbname
        else
            echo -e "python: \033[1;31m error: \033[0m no input file\nusage: ./python.sh [-option] <inputfile>.py"
            make clean > /dev/null
            exit 2
        ...
        if test -f "$2"; then
            ...
            cat $2 | ./python.out | python3 opt1.py > $fbname
        else
            echo -e "python: \033[1;31m error: \033[0m no input file\nusage: ./python.sh [-option] <inputfile>.py"
            make clean > /dev/null
            exit 2
        ...
        if test -f "$2"; then
            fbname=$(basename "$2" .py).S
            cat $2 | ./python.out | python3 compile.py > $fbname
        else
            echo -e "python: \033[1;31m error: \033[0m no input file\nusage: ./python.sh [-option] <inputfile>.py"
            make clean > /dev/null
            exit 2
    ...
    if test -f "$1"; then
        cat $1 | ./python.out | python3 opt1.py | python3 compile.py
    else
        echo -e "python: \033[1;31m error: \033[0m no input file\nusage: ./python.sh [-option] <inputfile>.py"
        make clean > /dev/null
        exit 2
